...
List<Widget> _buildExtrasTextList(List<ItemExtra> extrasList) {
  return List.generate(extrasList.length, (index) {
    final extraName = extrasList[index].name ?? '';
    final isLast = index == extrasList.length - 1;

    return Text(
      isLast ? '$extraName.' : '$extraName, ',
      style: TextStyle(
        fontFamily: 'Rubik',
        fontSize: 12.sp,
        fontWeight: FontWeight.w400,
