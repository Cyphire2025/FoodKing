...
class ApplyOfferView extends StatefulWidget {
  const ApplyOfferView({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text("ENTER_COUPON_CODE".tr, style: fontRegularBold),
                          InkWell(
                            onTap: () {
                              Get.back();
                            },
                              ...
                              child: SizedBox(
                                child: SizedBox(
                                  child: TextField(
                                    ...
                                    expands: false,
                                    controller:
                                        cartController.couponTextController,
                        ...
                        builder:
                            (couponController) => Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("OFFER_FOR_YOU".tr, style: fontMedium),
                                  Text(
                                                                            ...
                                                                            child: Padding(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Text(
                                                                                    couponController.couponDataList[index].description.toString(),
                                                                                    style:
                                                                                        fontRegular,
                                                                                    overflow:
