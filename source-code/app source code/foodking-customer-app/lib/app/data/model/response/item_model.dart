...
class VariationName {
  ...
  VariationName({this.id, this.name, this.attributeName});
...
class ItemAttribute {
  ItemAttribute({this.id, this.name, this.status});
  ...
  factory ItemAttribute.fromJson(Map<String, dynamic> json) =>
      ItemAttribute(id: json["id"], name: json["name"], status: json["status"]);
