                    ...
                    <thead class="db-table-head">
                        <tr class="db-table-head-tr">
                            ...
                            <th class="db-table-head-th hidden-print"
                                v-if="permissionChecker('dining-tables_show') || permissionChecker('dining-tables_edit') || permissionChecker('dining-tables_delete')">
                                {{ $t('label.action') }}
                            </th>
                        </tr>
                    </thead>
                            ...
                            <td class="db-table-body-td hidden-print"
                                ...
                                <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                    ...
                                    <SmIconViewComponent :link="'admin.diningTable.show'" :id="diningTable.id"
                                        v-if="permissionChecker('dining-tables_show')" />
                                    <SmIconSidebarModalEditComponent @click="edit(diningTable)"
                                        v-if="permissionChecker('dining-tables_edit')" />
                                    <SmIconDeleteComponent @click="destroy(diningTable.id)"
                                        v-if="permissionChecker('dining-tables_delete') && demoChecker(diningTable.id)" />
                                </div>
                            </td>
                        </tr>
                    </tbody>
