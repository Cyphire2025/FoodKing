        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="size" class="db-field-title">{{ $t("label.size") }} (ml)</label>
                        <input v-model="props.form.size" v-bind:class="errors.size ? 'invalid' : ''" type="text"
                            id="size" class="db-field-control" placeholder="237 ml">
                        <small class="db-field-alert" v-if="errors.size">{{ errors.size[0] }}</small>
                    </div>

                    <div class="form-col-12 sm:form-col-6">
                        <label for="calories" class="db-field-title">{{ $t("label.calories") }} (kcal)</label>
                        <input v-model="props.form.calories" v-bind:class="errors.calories ? 'invalid' : ''"
                            type="number" min="0" id="calories" class="db-field-control" placeholder="224">
                        <small class="db-field-alert" v-if="errors.calories">{{ errors.calories[0] }}</small>
                    </div>
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                fd.append('size', this.props.form.size == null ? '' : this.props.form.size);
                fd.append('calories', this.props.form.calories == null ? '' : this.props.form.calories);
