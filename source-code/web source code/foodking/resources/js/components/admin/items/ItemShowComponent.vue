    ...
    <div class="col-12">
        ...
        <div class="db-tabDiv active" id="information">
            <div class="row py-2">
                ...
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.size') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item.size || '--' }}</span>
                    </div>
                </div>

                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.calories') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item.calories ? item.calories + ' kcal' : '--' }}</span>
                    </div>
                </div>
