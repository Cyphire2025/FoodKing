<template>
    ...
    <footer class="footer-part pt-12 mb-14 lg:mb-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-6">
                <div>
                    <router-link :to="{ name: 'frontend.home' }">
                        <img class="mb-8 w-36" :src="setting.theme_footer_logo || '/images/theme/theme-footer-logo.png'"
                            @error="$event.target.src = '/images/theme/theme-footer-logo.png'" alt="logo">
                    </router-link>
        ...
        <div class="py-8 mt-8 border-t border-white/15">
