...
class FrontendOrderService
{
            ...
            DB::transaction(function () use ($request) {
                $this->frontendOrder = FrontendOrder::create(
                    $request->validated() + [
                        ...
                        'payment_method'   => $this->paymentMethodId($request->checkout_payment_method),
    ...
    private function paymentMethodId(string $method): int
    {
        return PaymentGateway::where('slug', $method)->value('id');
    }
