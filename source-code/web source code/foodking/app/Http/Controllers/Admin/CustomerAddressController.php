...
class CustomerAddressController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:customers_show', only: ['index']),
            new Middleware('permission:customers_show', only: ['store']),
            new Middleware('permission:customers_show', only: ['update']),
            new Middleware('permission:customers_show', only: ['destroy']),
