...
class OfferItemController extends AdminController implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('permission:offers_show', only: ['store']),
            new Middleware('permission:offers_show', only: ['destroy']),
        ];
    }
