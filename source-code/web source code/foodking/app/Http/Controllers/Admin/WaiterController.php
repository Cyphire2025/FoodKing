...
class WaiterController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:waiters', only: ['index']),
            new Middleware('permission:waiters', only: ['export']),
            new Middleware('permission:waiters', only: ['changePassword']),
            new Middleware('permission:waiters', only: ['changeImage']),
            new Middleware('permission:waiters', only: ['myOrder']),
            new Middleware('permission:waiters_create', only: ['store']),
            new Middleware('permission:waiters_edit', only: ['update']),
            new Middleware('permission:waiters_delete', only: ['destroy']),
    ...
    public function show(User $waiter
    ) : \Illuminate\Http\Response | WaiterResource | \Illuminate\Contracts\Foundation\Application | \Illuminate\Contracts\Routing\ResponseFactory {
        try {
