...
class EmployeeAddressController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:employees_show', only: ['index']),
            new Middleware('permission:employees_show', only: ['store']),
            new Middleware('permission:employees_show', only: ['update']),
            new Middleware('permission:employees_show', only: ['destroy']),
            new Middleware('permission:employees_show', only: ['show']),
        ];
    }
