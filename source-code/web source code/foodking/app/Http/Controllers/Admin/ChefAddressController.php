...
class ChefAddressController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:chefs_show', only: ['index']),
            new Middleware('permission:chefs_show', only: ['store']),
            new Middleware('permission:chefs_show', only: ['update']),
            new Middleware('permission:chefs_show', only: ['destroy']),
