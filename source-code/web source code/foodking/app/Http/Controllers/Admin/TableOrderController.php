...
class TableOrderController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:table-orders', only: ['index']),
            new Middleware('permission:table-orders', only: ['show']),
            new Middleware('permission:table-orders', only: ['export']),
            new Middleware('permission:table-orders', only: ['changeStatus']),
            new Middleware('permission:table-orders', only: ['changePaymentStatus']),
            new Middleware('permission:table-orders', only: ['selectDeliveryBoy']),
        ];
    }
