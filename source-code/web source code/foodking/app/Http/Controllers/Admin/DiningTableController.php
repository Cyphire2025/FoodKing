...
class DiningTableController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:dining-tables|pos', only: ['index']),
            new Middleware('permission:dining-tables', only: ['export']),
            new Middleware('permission:dining-tables_create', only: ['store']),
            new Middleware('permission:dining-tables_edit', only: ['update']),
            new Middleware('permission:dining-tables_delete', only: ['destroy']),
            new Middleware('permission:dining-tables_show', only: ['show']),
        ];
    }
