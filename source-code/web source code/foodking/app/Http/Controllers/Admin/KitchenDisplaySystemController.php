...
class KitchenDisplaySystemController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:kitchen-display-system', only: ['index']),
            new Middleware('permission:kitchen-display-system', only: ['changeStatus']),
            new Middleware('permission:kitchen-display-system', only: ['orderItems']),
        ];
    }
