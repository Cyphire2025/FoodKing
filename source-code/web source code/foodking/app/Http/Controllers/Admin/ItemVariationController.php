...
class ItemVariationController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:items_show', only: ['index']),
            new Middleware('permission:items_show', only: ['listGroupByAttribute']),
            new Middleware('permission:items_show', only: ['show']),
            new Middleware('permission:items_show', only: ['store']),
            new Middleware('permission:items_show', only: ['update']),
            new Middleware('permission:items_show', only: ['destroy']),
