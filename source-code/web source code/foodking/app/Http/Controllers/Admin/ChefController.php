...
class ChefController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:chefs', only: ['index']),
            new Middleware('permission:chefs', only: ['export']),
            new Middleware('permission:chefs', only: ['changePassword']),
            new Middleware('permission:chefs', only: ['changeImage']),
            new Middleware('permission:chefs', only: ['myOrder']),
            new Middleware('permission:chefs_create', only: ['store']),
            new Middleware('permission:chefs_edit', only: ['update']),
            new Middleware('permission:chefs_delete', only: ['destroy']),
            new Middleware('permission:chefs_show', only: ['show']),
        ];
    }
