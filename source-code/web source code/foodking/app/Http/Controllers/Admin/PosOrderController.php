...
class PosOrderController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:pos-orders', only: ['index']),
            new Middleware('permission:pos-orders|pos', only: ['show']),
            new Middleware('permission:pos-orders', only: ['destroy']),
            new Middleware('permission:pos-orders', only: ['export']),
            new Middleware('permission:pos-orders', only: ['changeStatus']),
            new Middleware('permission:pos-orders', only: ['changePaymentStatus']),
            new Middleware('permission:pos-orders', only: ['selectDeliveryBoy']),
        ];
    }
