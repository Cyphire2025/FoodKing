...
class ItemsReportController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:items-report', only: ['index']),
            new Middleware('permission:items-report', only: ['export']),
            new Middleware('permission:items-report', only: ['pdf']),
