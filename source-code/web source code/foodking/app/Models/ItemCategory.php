...
class ItemCategory extends Model implements HasMedia
{
    ...
    {
        $this->addMediaConversion('thumb')->width(112)->height(72)->keepOriginalImageFormat()->sharpen(10);
        $this->addMediaConversion('cover')->width(400)->height(100)->keepOriginalImageFormat()->sharpen(10);
    }
