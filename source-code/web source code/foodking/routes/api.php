...
use App\Http\Controllers\Admin\AppIntroVideoController;
...
use App\Http\Controllers\Admin\TodaySpecialController;
...
Route::prefix('auth')->middleware(['installed', 'apiKey', 'localization'])->name('auth.')->namespace('Auth')->group(function () {
    ...
    Route::post('/login/{provider}/mobile', [SocialLoginController::class, 'verifyMobileSocialLogin'])->name('verifyMobileSocialLogin');
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('today-special')->name('today-special.')->group(function () {
        Route::get('/', [TodaySpecialController::class, 'index']);
        Route::match(['put', 'patch'], '/', [TodaySpecialController::class, 'update']);
    });

    Route::prefix('app-intro-video')->name('app-intro-video.')->group(function () {
        Route::get('/', [AppIntroVideoController::class, 'index']);
        Route::post('/', [AppIntroVideoController::class, 'update']);
    });

    Route::prefix('app-update')->name('app-update.')->group(function () {
        Route::get('/', [AppUpdateController::class, 'index']);
        Route::post('/', [AppUpdateController::class, 'store']);
        Route::post('/{appUpdateSetting}', [AppUpdateController::class, 'update']);
        Route::delete('/{appUpdateSetting}', [AppUpdateController::class, 'destroy']);
    });

    Route::prefix('app-design')->name('app-design.')->group(function () {
        Route::get('/', [AppDesignController::class, 'index']);
        Route::post('/color', [AppDesignController::class, 'updateColor']);
        Route::post('/banners', [AppDesignController::class, 'updateBanners']);
    });
